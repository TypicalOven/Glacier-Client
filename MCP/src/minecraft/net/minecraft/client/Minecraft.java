...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Glacier Client " + Glacier.INSTANCE.VERSION + " - Minecraft 1.8.9");
    ...
    {
        EventClientTick e = new EventClientTick();
        e.call();
