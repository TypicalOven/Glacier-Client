...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        Glacier.INSTANCE.manager.renderHook();

        if(!Glacier.INSTANCE.networkClient.loggedInToServer) {
            getFontRenderer().drawStringWithShadow("You are not connected to Glacier Client servers!",
                    scaledresolution.getScaledWidth() / 2 - getFontRenderer().getStringWidth("You are not connected to Glacier Client servers!") / 2,
                    150, -1);
        }
