...
import me.quick.glacier.util.misc.WebhookUtil;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    {
    	if(!message.startsWith(".bugreport")) {
    		...
    		String bugReport = message.split(".bugreport ")[1];
    		
    		if(!bugReport.contains("@")) {
    			WebhookUtil.sendMessage("The user **" + mc.thePlayer.getGameProfile().getName() + "** reported a bug: ```" + bugReport + "```", WebhookUtil.bugReport);
    			Glacier.sendMessage("Your bug report has been submitted!");
    		} else {
    			Glacier.sendMessage("Did you try to ping someone? If not, please open a ticket to report this bug!");
    		}
    	}
    }
